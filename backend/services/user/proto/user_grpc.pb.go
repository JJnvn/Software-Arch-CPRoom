...
const (
	...
	UserService_GetBookingHistory_FullMethodName = "/user.UserService/GetBookingHistory"
...
type UserServiceClient interface {
	...
	// Booking History
	GetBookingHistory(ctx context.Context, in *GetBookingHistoryRequest, opts ...grpc.CallOption) (*BookingHistoryResponse, error)
	// Preferences
...
func (c *userServiceClient) GetBookingHistory(ctx context.Context, in *GetBookingHistoryRequest, opts ...grpc.CallOption) (*BookingHistoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BookingHistoryResponse)
	err := c.cc.Invoke(ctx, UserService_GetBookingHistory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	// Booking History
	GetBookingHistory(context.Context, *GetBookingHistoryRequest) (*BookingHistoryResponse, error)
	// Preferences
...
func (UnimplementedUserServiceServer) GetBookingHistory(context.Context, *GetBookingHistoryRequest) (*BookingHistoryResponse, error) {
...
func _UserService_GetBookingHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBookingHistoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetBookingHistory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetBookingHistory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetBookingHistory(ctx, req.(*GetBookingHistoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_GetBookingHistory_Handler,
		},
		{
